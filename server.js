          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  'div',
                  { className: 'medium-8 large-6 columns' },
                  _react2['default'].createElement(
                    'h2',
                    null,
                    'Contact Me'
                ...
                _react2['default'].createElement(
                  'div',
                  { className: 'Contact-leftSectionImg medium-4 large-6 columns' },
                  _react2['default'].createElement('img', { className: 'small-5 medium-10 large-5', src: 'https://res.cloudinary.com/dp1pal3mi/image/upload/v1442042607/me_kod5c8.png' })
                )
              ),
              _react2['default'].createElement(
                'div',
      ...
      value: function render() {
        ...
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement('script', { src: 'https://cdnjs.cloudflare.com/ajax/libs/three.js/r72/three.min.js' }),
            _react2['default'].createElement('script', { src: 'http://www.paulgraffix.com/js/threeX.windowResize.js' }),
            _react2['default'].createElement('script', { src: 'http://threejs.org/examples/js/postprocessing/EffectComposer.js' }),
            _react2['default'].createElement('script', { src: 'http://threejs.org/examples/js/shaders/CopyShader.js' }),
            _react2['default'].createElement('script', { src: 'http://threejs.org/examples/js/shaders/ConvolutionShader.js' }),
            _react2['default'].createElement('script', { src: 'http://threejs.org/examples/js/shaders/FXAAShader.js' }),
            _react2['default'].createElement('script', { src: 'http://threejs.org/examples/js/postprocessing/ShaderPass.js' }),
            _react2['default'].createElement('script', { src: 'http://threejs.org/examples/js/postprocessing/MaskPass.js' }),
            _react2['default'].createElement('script', { src: 'http://threejs.org/examples/js/postprocessing/RenderPass.js' }),
            _react2['default'].createElement('script', { src: 'http://threejs.org/examples/js/postprocessing/BloomPass.js' }),
            _react2['default'].createElement('script', { src: 'js/lightWaves.js' }),
